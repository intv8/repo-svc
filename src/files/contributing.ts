...
&grave;partic11e/please&grave; repo.
...
[issues]: https://github.com/partic11e/${"pkg.name"}/issues/new?template=issue.yaml&title= "Report an issue in partic11e/${"pkg.name"}"
[feature]: https://github.com/partic11e/${"pkg.name"}/issues/new?template=feature.md&title= "Request a new feature in partic11e/${"pkg.name"}"
[documentation]: https://github.com/partic11e/${"pkg.name"}/labels/type%3A%20docs "Documentation issues in partic11e/${"pkg.name"}"
[first-issue]: https://github.com/partic11e/${"pkg.name"}/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22 "Good first issues in partic11e/${"pkg.name"}"
`;
