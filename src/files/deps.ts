 ...
 * This file re-exports external dependencies used by the kz.io ${"pkg.name"} package.
 *
 * @copyright 2022 integereleven. All rights reserved. MIT license.
 */

export { Exception, type TExceptionInit } from "https://denopkg.com/kz-io/core/mod.ts";
`;
